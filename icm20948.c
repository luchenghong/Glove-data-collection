...
//static unsigned char gyro_smpdiv = 4; //sampling rate = 1125/(1+smpdiv), 8bits
//static unsigned int  acc_smpdiv  = 4; //sampling rate = 1125/(1+smpdiv), 12 bits
...
int configMPU()
{
	...
	gyro_fsr = GFS_CONFIG;
	value = (GYRO_DLPF_151<<3)|(gyro_fsr<<1)|0x01;
